...
async def taskdone(interaction: discord.Interaction):
    ...
    for guild in bot.guilds:
        ...
        if (
            ...
            juniorDevs not in interaction.user.roles
            or seniorDevs not in interaction.user.roles
            or leadDevs not in interaction.user.roles
            or projectManagers not in interaction.user.roles
        ):
            await interaction.response.send_message(
